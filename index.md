...
carpentry: "deep"    # what kind of Carpentry (must be either "lc" or "dc" or "swc").  
                      # Be sure to update the Carpentry type in _config.yml as well.  
venue: "Python for Dynamics and Evolution of Earth and Planets"        # brief name of host site without address (e.g., "Euphoric State University")
address: "conference room at CEED, UiO, Oslo"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "59.939637, 10.723291"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "1 - 5 April 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Nils Charles Prieur and Anne Fouilloux"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
{% elsif page.carpentry == "deep" %}
{% include deep/schedule.html %}
{% endif %}
...
{% elsif page.carpentry == "deep" %}
Training material for this workshop is available [here](https://nordicesmhub.github.io/deep_python/).
{% endif %}
